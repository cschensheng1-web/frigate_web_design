...
const WorldCalibration = lazy(() => import("@/pages/WorldCalibration"));
const Trajectories = lazy(() => import("@/pages/Trajectories"));
const VideoPipe = lazy(() => import("@/pages/VideoPipe"));
        ...
        >
          <Routes>
            <Route element={<ProtectedRoute requiredRoles={mainRouteRoles} />}>
              ...
              <Route path="/videopipe" element={<VideoPipe />} />
            ...
            <Route element={<ProtectedRoute requiredRoles={["admin"]} />}>
              ...
              <Route
                path="/calibration/world"
                element={<WorldCalibration />}
              />
